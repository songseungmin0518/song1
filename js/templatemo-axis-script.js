...
if (clockEl) {
    function updateClock() {
        const n = new Date();
        const korea = new Date(n.toLocaleString("en-US", { timeZone: "Asia/Seoul" }));

        clockEl.textContent =
            String(korea.getHours()).padStart(2, '0') + ':' +
            String(korea.getMinutes()).padStart(2, '0') + ':' +
            String(korea.getSeconds()).padStart(2, '0') + ' KST';
    }
    updateClock();
